...
const Restaurants=[

                  {
                    ...
                    "analytics": {
                      "context": "seo-data-118a1ca0-d2ed-46ab-a3cd-404b80848d60"
                    },
                    "cta": {
                  ...
                  },
                  {
                    "info": {
                      "id": "67970",
                      "name": "Subway",
                      "cloudinaryImageId": "RX_THUMBNAIL/IMAGES/VENDOR/2025/1/21/ee031666-e182-44aa-a55d-07c18dd502a4_67970.JPG",
                      "locality": "Snehnagar",
                  ...
                  },
                  {
                    ...
                    "cta": {
                      "link": "https://www.swiggy.com/city/indore/burger-singh-big-punjabi-burgers-bhanwar-kuan-bhawar-kuan-rest816024",
                      "text": "RESTAURANT_MENU",
                      "type": "WEBLINK"
                    },
                    "widgetId": "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
...
const Cards=(props)=>{
    ...
    // const resList=props;
    // console.log(props.resList[0].info.name)
    // console.log(props.resList[0].info.cloudinaryImageId)
    // console.log(props.resList.name)
    ...
    return (
        <div className="body">
          ...
          <div className="res-container">
            {/* <Cards resList={Restaurants[0]}/>
            <Cards resList={Restaurants[1]}/>
            <Cards resList={Restaurants[2]}/>
            <Cards resList={Restaurants[3]}/>
            <Cards resList={Restaurants[4]}/>
            <Cards resList={Restaurants[5]}/>
            <Cards resList={Restaurants[6]}/> */}

{Restaurants.map((restaurant) => (
  <Cards key={restaurant.info.id} resList={restaurant} />
))}
